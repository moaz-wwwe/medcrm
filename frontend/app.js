    ...
    try {
        ...
        data.forEach(lead => {
            ...
            card.innerHTML = `
                ...
                <p style="font-size:0.875rem; margin-bottom:4px;" dir="rtl"><strong>ملاحظات العميل:</strong> ${lead.notes || 'لا يوجد'}</p>
                ${lead.latest_call_log ? `<p style="font-size:0.875rem; margin-bottom:4px; color: var(--accent-primary); text-align: right;" dir="rtl"><strong>ملاحظات المندوب (المكالمة):</strong> ${lead.latest_call_log.notes || 'لا يوجد'}</p>` : ''}
